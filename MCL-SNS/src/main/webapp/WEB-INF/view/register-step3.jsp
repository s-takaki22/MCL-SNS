	...
	<body>
		...
		<form action="RegisterAccountServlet" enctype="multipart/form-data" method="post" class="mb-3 m-5">
				<label class="form-label">メールアドレス</label>
					<input readonly type="email" value="<%=onetime.getMail() %>" name="mail" required="required" class="form-control">
				...
				<label class="form-label">学校名</label>
					<input type="text" name="schoolName" required="required" class="form-control">
				<label class="form-label">学生証(
					...
					<input type="file" accept=".jpg, .jpeg, .png" name="upfile" required="required" class="form-control"><br>
