...
<body>
	...
	%>
	<form action="FollowServlet" class="mb-5 m-5">
		<input type="hidden" name="account-name" value="<%=ac.getNickName() %>">
		<input type="text" value="<%=(list.get(i)).getAccountName() %>" name="name" readonly>
